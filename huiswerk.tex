...
\pagestyle{fancy}{
	\fancyhead{}
	\fancyfoot{}
	\fancyfoot[LO,RE]{Assignment-6}					% For double sided printing, layout differs on even/odd pages
...
\input{./tex/preamble.tex}						% For the sake of a modular document layout...
\cleardoublepage{}
\input{./tex/xml.tex}
\cleardoublepage{}
\input{./tex/regex.tex
